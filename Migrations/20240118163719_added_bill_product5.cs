...
{
    /// <inheritdoc />
    public partial class added_bill_product5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice_NoVAT = table.Column<double>(type: "double precision", nullable: false),
                    TotalPrice_VAT = table.Column<double>(type: "double precision", nullable: true),
                    SellerCompanyId = table.Column<string>(type: "text", nullable: false),
                    BuyerCompanyId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bills", x => x.BillId);
                    table.ForeignKey(
                        name: "FK_Bills_AspNetUsers_BuyerCompanyId",
                        column: x => x.BuyerCompanyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bills_AspNetUsers_SellerCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_BuyerCompanyId",
                table: "Bills",
                column: "BuyerCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Bills_SellerCompanyId",
                table: "Bills",
